                ...
                <nav role="navigation" className="nav_menu w-nav-menu">
                  <div className="nav_menu-inner">
                    <ul id="" className="nav_menu-links">
                      ...
                      <li className="nav_menu-li">
                        <div className="nav_dropdown">
                          <button
                            className="nav_menu-link nav_dropdown-toggle text-sm! mt-0.5!"
                    ...
                    <div className="nav_menu-buttons">
                      <div className="nav_social-icons">
                        <a
                          href="https://t.me/lambdaprivacy"
                          target="_blank"
                          rel="noopener noreferrer"
                          aria-label="Join Lambda on Telegram"
                          className="nav_social-link"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="18"
