  ...
  ["232"],
  {
    5487: function () {
      ...
      window.tram = (function (e) {
        ...
        var u,
          ...
          S = function (e) {
            ...
            for (t = 0; t < A.length; t++)
              if ((n = A[t] + i) in w.style) return { dom: n, css: N[t] + e };
          },
          C = (t.support = {
        ...
        if (C.transition) {
          var R = C.timing.dom;
          if (((w.style[R] = d["ease-in-back"][0]), !w.style[R]))
              ...
              i.analytics = {
                optOut: function (e) {
                  ...
                  if ("function" == typeof wf?.denyUserTracking)
                    return void wf.denyUserTracking({ reload: n });
                  let i = t.attr("data-wf-intellimize-customer-id");
                  if (i) {
                    let e = `intellimize_opt_out_${i}`;
                    if (localStorage.getItem(e)) return;
                    (localStorage.setItem(`intellimize_opt_out_${i}`, !0),
                      n && location.reload());
                  }
                },
                optIn: function (e) {
                  ...
                  if ("function" == typeof wf?.allowUserTracking)
                    return void wf.allowUserTracking({ reload: n });
                  let i = t.attr("data-wf-intellimize-customer-id");
                  if (i) {
                    let e = `intellimize_opt_out_${i}`;
                    if (!localStorage.getItem(e)) return;
                    (localStorage.removeItem(`intellimize_opt_out_${i}`),
                      n && location.reload());
                  }
                },
    ...
    3949: function (e, t, n) {
      ...
      ((a.env.safari = /safari/.test(I) && !v && !_),
        T &&
                ...
                p.on(
                  ...
                  function () {
                    r(
                      ...
                      a,
                      (e) => {
                        ((s.turnstileToken = e), w(s), N(u, !1));
                      },
                      () => {
                        (w(s), s.btn && s.btn.prop("disabled", !0), N(u, !1));
                      },
                    );
                  },
                )));
        ...
        (e.exports = function (e, t) {
          ...
          function w(n, i) {
            ...
            (m ||
              ...
              (m.outside =
                ((r = m).outside && f.off("click" + E, r.outside),
                function (t) {
                  var n = e(t.target);
          ...
          function S(e) {
            ...
            ((n.animOver = /^over/.test(r)),
              ...
              i.animation !== r && e.open && t.defer(R, e),
            ...
            s.preview =
              function () {
                ((u = g && i.env("design")),
                  (c = i.env("editor")),
                  (n = e(document.body)),
                  (o = f.find(E)).length && (o.each(w), b(), i.resize.on(O)));
              }),
            (s.destroy = function () {
    ...
    1970: function (e, t, n) {
      ...
      function K(e) {
        (R({ store: e, select: ({ ixRequest: e }) => e.preview, onChange: Z }),
          R({
            store: e,
          ...
          R({ store: e, select: ({ ixRequest: e }) => e.clear, onChange: en }));
      }
      ...
      function ee(e, t) {
        ...
        if (i && r && l && u) {
          ...
          e && (l = x({ actionList: e, actionItemId: r, rawData: l }));
        }
        if (
      ...
      function er(e) {
        ...
        if (t.active) {
          ...
          (n.forEach(ea), j(), e.dispatch((0, E.sessionStopped)()));
        }
      }
        ...
        if (s && s.useFirstGroupAsInitialState) {
          ...
          a.forEach((i) => {
            ...
            o.forEach((r) => {
              ...
              eE({
                destination: C({ element: r, actionItem: i, elementApi: m }, o),
                immediate: !0,
                store: e,
                element: r,
                eventId: n,
      ...
      function ep({
        ...
        let { ixInstances: a, ixSession: u } = e.getState(),
          c = u.hasBoundaryNodes && n ? m.getClosestElement(n, b) : null;
        (0, d.default)(a, (n) => {
      ...
      function eg({
        ...
        let I = l.hasBoundaryNodes && n ? m.getClosestElement(n, b) : null,
          T = M(y),
          _ = !1;
        return (
          y.forEach((o, s) => {
            ...
            g &&
              N({
                ...
                let g = p ? H(d)?.(l, o) : null,
                  E = p ? z(d)(l, o) : null;
                _ = !0;
                let y = D({ element: l, actionItem: o }),
                  I = C({ element: l, actionItem: o, elementApi: m }, g);
                eE({
                  store: e,
                  element: l,
                  actionItem: o,
      ...
      function eE(e) {
        ...
        (R({ store: n, select: ({ ixInstances: e }) => e[f], onChange: ey }),
          s || n.dispatch((0, E.instanceStarted)(f, h.tick)));
      }
      function em(e, t) {
        ...
        let { elementId: n, actionItem: i } = e,
          ...
          { ref: a, refType: o } = r[n] || {};
        (o === O && B(a, i, m), t.dispatch((0, E.instanceRemoved)(e.id)));
      }
      function eh(e, t, n) {
      ...
      function ey(e, t) {
        ...
        if (U(A, _.mediaQueryKey) && (i || n || r)) {
          if (s || (c === w && r)) {
            t.dispatch((0, E.elementStateChanged)(a, u, s, o));
            let { ixElements: e } = t.getState(),
              { ref: n, refType: i, refState: r } = e[a] || {},
              l = r && r[u];
            (i === O || $(u)) && P(n, r, l, d, o, y, m, c, T);
          }
          if (r) {
            if (h) {
              let e = eg({
      ...
      let {
        ...
        ea = (e) => (t, n) => {
          let { type: i } = t.nativeEvent,
            r = -1 !== [x, G].indexOf(i) ? i === x : n.isActive,
            a = { ...n, isActive: r };
        ...
        eu =
          ...
          (t, n = {}) => {
            ...
            return (n && m && (r || h.inBounds !== n.inBounds) && e(t, h)) || h;
          },
        ec = (e, t) =>
          e.left > t.left &&
          e.left < t.right &&
        ...
        ep = {
          ...
          [F]: { types: "ecommerce-cart-close", handler: z(W, H) },
          [f]: {
            types: "click",
            handler: z(
              W,
            ...
            handler: (
              ...
              switch (o) {
                ...
                case u.EventBasedOn.PAGE: {
                  ...
                  I = h ? Math.min(e + E, n) / n : Math.min(t + m, i) / i;
                  break;
                }
          ...
          [D]: {
            types: "readystatechange IX2_PAGE_UPDATE",
            handler: z(j, (e, t) => (t || H(e), { started: !0 })),
          },
        };
    },
    4609: function (e, t, n) {
    ...
    4124: function (e, t, n) {
      ...
      let {
        ...
        eu = (e) => e.trim(),
        ec = Object.freeze({ [en]: L, [ei]: P, [er]: F }),
        es = Object.freeze({
      ...
      function eT({
        ...
        if (
          (N
            ...
            : (o = u = d({ id: T, selector: _, selectorGuids: b })),
          t && w)
        ) {
          let e = n && (u || !0 === w) ? [n] : f(S);
          if (u) {
            if (w === x) return f(u).filter((t) => e.some((e) => h(t, e)));
            if (w === M) return f(u).filter((t) => e.some((e) => h(e, t)));
      ...
      function eC({ element: e, actionItem: t, elementApi: n }) {
        ...
        switch (t.actionTypeId) {
          ...
          case et: {
            ...
            if (!g.IS_BROWSER_ENV) return { widthValue: c, heightValue: s };
            if (o === U) {
              let t = i(e, C);
            ...
            if (u === U) {
              let t = i(e, R);
              (r(e, R, ""), (s = a(e, "offsetHeight")), r(e, R, t));
            }
        ...
        switch (c) {
          case W:
            ...
            let h = ex
                ...
                .join(" "),
              { setStyle: A } = m;
            (eU(l, g.TRANSFORM_PREFIXED, m),
              A(l, g.TRANSFORM_PREFIXED, h),
              (function (
                { actionTypeId: e },
              ...
              })(E, f) && A(l, g.TRANSFORM_STYLE_PREFIXED, O));
            return;
          case $:
      ...
      function eW({ actionGroup: e, event: t, elementApi: n }) {
        ...
        i.forEach((e) => {
          ...
          ((i = (0, p.isPluginType)(r)
            ...
            eT({ config: a, event: t, elementApi: n }).forEach(i));
        });
      }
      function eY(e, t, n) {
        ...
        if (a === et) {
          let { config: n } = t;
          (n.widthUnit === U && i(e, C, ""), n.heightUnit === U && i(e, R, ""));
        }
          ...
          switch (t.type) {
            ...
            case I: {
              let {
                ...
                s = e;
              return (
                (0, a.getIn)(s, [n, i]) !== i && (s = b(s, i, u, n, o)),
                O(s, n, c, r, o)
              );
            }
            case T: {
      ...
      Webflow.require("ix2").init({
        events: {
          e: {
            ...
            target: {
              id: "680a96528636c3f0df9b8a8b|764474b6-5890-6912-c9e2-c582864c79b7",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-2": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "680a96528636c3f0df9b8a8b|1759f8ea-1359-eb1f-1908-2490d0c588a4",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-3": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "680a96528636c3f0df9b8a8b|4cc869bc-1c93-ae7a-4993-f3288a903d11",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-4": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "680a96528636c3f0df9b8a8b|2ffeab5b-7897-874e-3a33-531350daf38e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-17": {
            ...
            target: {
              ...
              originalId: "7d6f166a-4a6a-4b1d-554d-dcf9469a3ac3",
              appliesTo: "CLASS",
            },
            targets: [
              {
          ...
          "e-25": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6813f1df68d3b06748d897d9|240c05d1-f710-797d-0c0e-2162a964414d",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-26": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6813f1df68d3b06748d897d9|240c05d1-f710-797d-0c0e-2162a964415a",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-27": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6813f1df68d3b06748d897d9|240c05d1-f710-797d-0c0e-2162a9644167",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-28": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "6813f1df68d3b06748d897d9|240c05d1-f710-797d-0c0e-2162a9644174",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-29": {
            ...
            mediaQueries: ["main"],
            target: {
              id: "6813f1df68d3b06748d897d9|c11466d6-a758-c9ab-f2c4-bd8bd6000a9e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-31": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "684994f6f2702d16721b6e6e|4dbd4470-7308-5e3a-c27c-62be10831d47",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-32": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "684994f6f2702d16721b6e6e|4dbd4470-7308-5e3a-c27c-62be10831d54",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-33": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "684994f6f2702d16721b6e6e|4dbd4470-7308-5e3a-c27c-62be10831d61",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-34": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
              id: "684994f6f2702d16721b6e6e|4dbd4470-7308-5e3a-c27c-62be10831d6e",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
          ...
          "e-35": {
            ...
            mediaQueries: ["main"],
            target: {
              id: "684994f6f2702d16721b6e6e|4dbd4470-7308-5e3a-c27c-62be10831dc4",
              appliesTo: "ELEMENT",
              styleBlockIds: [],
            },
            targets: [
        ...
        actionLists: {
          a: {
            id: "a",
            title: "[Product] Card Into View 1st",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_card-wrap.is-1st",
                            selectorGuids: [
                              "1d7e8bb6-925d-889b-b361-393677a5f9ac",
                              "12be12d8-375e-663c-18d0-6ac953a8b68e",
                            ],
                          },
                          xValue: 1,
                          yValue: 1,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_overlay.is-1st",
                            selectorGuids: [
                              "46de1ace-656b-f071-cffa-f7614a33b8d0",
                              "186c935b-dd32-3eff-02b2-dfb739076f63",
                            ],
                          },
                          value: 0,
                          unit: "",
            ...
            createdOn: 0x196696185f9,
          },
          "a-2": {
            id: "a-2",
            title: "[Product] Card Into View 2nd",
            continuousParameterGroups: [
              {
                id: "a-2-p",
                type: "SCROLL_PROGRESS",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_card-wrap.is-2nd",
                            selectorGuids: [
                              "1d7e8bb6-925d-889b-b361-393677a5f9ac",
                              "1d979ecc-dc40-df56-336e-ece085512c8b",
                            ],
                          },
                          xValue: 1,
                          yValue: 1,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_overlay.is-2nd",
                            selectorGuids: [
                              "46de1ace-656b-f071-cffa-f7614a33b8d0",
                              "901c8ab3-cfd9-0a5c-bdb0-2f0453a5a18d",
                            ],
                          },
                          value: 0,
                          unit: "",
          ...
          "a-3": {
            id: "a-3",
            title: "[Product] Card Into View 3rd",
            continuousParameterGroups: [
              {
                id: "a-3-p",
                type: "SCROLL_PROGRESS",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_card-wrap.is-3rd",
                            selectorGuids: [
                              "1d7e8bb6-925d-889b-b361-393677a5f9ac",
                              "68b8da6d-f8ef-13cf-59fc-890fef485fe7",
                            ],
                          },
                          xValue: 1,
                          yValue: 1,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_overlay.is-3rd",
                            selectorGuids: [
                              "46de1ace-656b-f071-cffa-f7614a33b8d0",
                              "f146d46d-4c15-333e-e9dc-b710e92aaf17",
                            ],
                          },
                          value: 0,
                          unit: "",
          ...
          "a-4": {
            id: "a-4",
            title: "[Product] Card Into View 4th",
            continuousParameterGroups: [
              {
                id: "a-4-p",
                type: "SCROLL_PROGRESS",
                    ...
                    actionItems: [
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_card-wrap.is-4th",
                            selectorGuids: [
                              "1d7e8bb6-925d-889b-b361-393677a5f9ac",
                              "bcf0ec20-4de2-06c2-efa3-76801a5c2ea5",
                            ],
                          },
                          xValue: 1,
                          yValue: 1,
                      ...
                      },
                      {
                        ...
                        config: {
                          ...
                          duration: 500,
                          target: {
                            selector: ".product-monitor_overlay.is-4th",
                            selectorGuids: [
                              "46de1ace-656b-f071-cffa-f7614a33b8d0",
                              "54a67e53-98f1-064c-a2db-dce17f26433d",
                            ],
                          },
                          value: 0,
                          unit: "",
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6dcc362f-215f-0fea-581b-34edec236406"],
                      },
                      value: "none",
                    },
                  },
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6dcc362f-215f-0fea-581b-34edec236417"],
                      },
                      value: 0,
                      unit: "",
                    },
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6dcc362f-215f-0fea-581b-34edec236420"],
                      },
                      xValue: 1,
                      xUnit: "rem",
                      yUnit: "PX",
                  ...
                  },
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6dcc362f-215f-0fea-581b-34edec236415"],
                      },
                      globalSwatchId: "--base--mono-orange",
                      rValue: 30,
                      bValue: 249,
                      gValue: 90,
                      aValue: 1,
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selectorGuids: ["6dcc362f-215f-0fea-581b-34edec23640d"],
                      },
                      value: "none",
                    },
                  },
          ...
          "a-19": {
                ...
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      duration: 500,
                      target: {
                        selector: ".lambda-method_lottie",
                        selectorGuids: ["54320f34-ea70-0b3a-5574-467d05ec5186"],
                      },
                      value: 0,
                    },
                  },
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x19687555f35,
          },
          "a-9": {
            id: "a-9",
            title: "[Product] Hover In Text Opacity 3",
            actionItemGroups: [
              {
                actionItems: [
                  {
                    ...
                    config: {
                      ...
                      target: {
                        ...
                        selector: ".product-card_text-wrap.is-3rd",
                        selectorGuids: [
                          "daa1562d-7e60-14dd-0e85-800e8c61b7cf",
                          "a0f34d7f-f6a9-7982-3d9e-4ae7e4a47b8f",
                        ],
                      },
                      value: "none",
                    },
            ...
            useFirstGroupAsInitialState: !0,
            createdOn: 0x19669f7cecd,
          },
          "a-10": {
            id: "a-10",
            title: "[Product] Hover Out Text Opacity 3",
            actionItemGroups: [
              {
                actionItems: [
                  {
